...
export class PersonServiceProxy {
     ...
     * @return Success
     */
    getAllPeople(): Observable<GetAllPeopleOutput> {
        let url_ = this.baseUrl + "/api/services/app/Person/GetAllPeople";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllPeople(<any>response_);
                } catch (e) {
                    return <Observable<GetAllPeopleOutput>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetAllPeopleOutput>><any>_observableThrow(response_);
        }));
    }

    protected processGetAllPeople(response: HttpResponseBase): Observable<GetAllPeopleOutput> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetAllPeopleOutput.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetAllPeopleOutput>(<any>null);
    }
}
...
export class TaskServiceProxy {
     ...
     * @return Success
     */
    getActiveTaskCount(): Observable<GetActiveTaskCountOutput> {
        let url_ = this.baseUrl + "/api/services/app/Task/GetActiveTaskCount";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetActiveTaskCount(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetActiveTaskCount(<any>response_);
                } catch (e) {
                    return <Observable<GetActiveTaskCountOutput>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetActiveTaskCountOutput>><any>_observableThrow(response_);
        }));
    }

    protected processGetActiveTaskCount(response: HttpResponseBase): Observable<GetActiveTaskCountOutput> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetActiveTaskCountOutput.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetActiveTaskCountOutput>(<any>null);
    }
     ...
     * @return Success
     */
    updateTask(body: UpdateTaskInput | undefined): Observable<void> {
     ...
     * @return Success
     */
    createTask(body: CreateTaskInput | undefined): Observable<void> {
...
export class GetAllPeopleOutput implements IGetAllPeopleOutput {
    people: PersonDto[] | undefined;

    constructor(data?: IGetAllPeopleOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GetAllPeopleOutput {
        data = typeof data === 'object' ? data : {};
        let result = new GetAllPeopleOutput();
        result.init(data);
        return result;
    }
...
export interface IGetAllPeopleOutput {
    people: PersonDto[] | undefined;
}
...
export class TaskDto implements ITaskDto {
    ...
    init(_data?: any) {
        if (_data) {
            this.assignedPersonId = _data["assignedPersonId"];
            this.assignedPersonName = _data["assignedPersonName"];
            this.description = _data["description"];
            this.creationTime = _data["creationTime"] ? moment(_data["creationTime"].toString()) : <any>undefined;
            this.state = _data["state"];
            this.id = _data["id"];
...
export class GetActiveTaskCountOutput implements IGetActiveTaskCountOutput {
    total: number;

    constructor(data?: IGetActiveTaskCountOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GetActiveTaskCountOutput {
        data = typeof data === 'object' ? data : {};
        let result = new GetActiveTaskCountOutput();
        result.init(data);
        return result;
    }
    ...
    clone(): GetActiveTaskCountOutput {
        const json = this.toJSON();
        let result = new GetActiveTaskCountOutput();
        result.init(json);
        return result;
...
export interface IGetActiveTaskCountOutput {
    total: number;
}
